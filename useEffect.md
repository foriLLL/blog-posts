useEffect第二个参数传入空数组相当于componentDidMount
...
# 发现问题：在rfc中的语句在每次re-render时都会执行一次，const变量传入return的组件中也会每次变化！
https://stackoverflow.com/questions/57289811/function-inside-functional-component-in-react-hooks-performance